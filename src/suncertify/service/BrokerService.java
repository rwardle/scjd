...
public interface BrokerService {
     ...
     * @throws ContractorModifiedException If the current data stored on the contractor does not
     ...
     * @throws IllegalArgumentException    If <code>customerId</code> is <code>null</code>,
