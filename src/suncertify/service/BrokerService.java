...
public interface BrokerService {
     ...
     *             If the current data stored on the contractor does not match the data supplied to
     *             this method (likely to be because the contractor has been modified since the
     *             client last retrieved the data).
     * @throws IllegalArgumentException
     *             If <code>customerId</code> is <code>null</code>, <code>customerId</code> does not
