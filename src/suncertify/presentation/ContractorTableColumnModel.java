...
public final class ContractorTableColumnModel extends DefaultTableColumnModel {
    ...
    private static final Dimension BOOK_BUTTON_DIMENSIONS = new Dimension(65, 15);
    ...
    public ContractorTableColumnModel() {
        ResourceBundle resourceBundle = ResourceBundle.getBundle("suncertify/presentation/Bundle");
        ...
        for (int i = 0; i < tableColumnNames.length; i++) {
            tableColumnNames[i] = resourceBundle.getString("MainFrame.resultsTable.column" + i
                    + ".text");
        }
        ...
        for (int i = 0; i < tableColumnNames.length; i++) {
            columnHeaderToolTips[i] = resourceBundle.getString("MainFrame.resultsTable.column" + i
                    + ".tooltip");
        }
        ...
        String bookButtonTooltip = resourceBundle.getString("MainFrame.bookButton.tooltip");
        ownerColumn.setCellRenderer(new OwnerTableCellRenderer(this, bookButtonTooltip));
        ownerColumn.setCellEditor(new OwnerTableCellEditor(this, bookButtonTooltip));
    }
    ...
    private JButton createBookButton() {
        ...
        button.setFont(new Font(defaultButtonFont.getName(), defaultButtonFont.getStyle(),
                BOOK_BUTTON_FONT_SIZE));
    ...
    /*
     * Renders the owner column as a book button if there is no owner. Using the flyweight pattern
     * for the bookButtonPanel renderer component.
     */
    private static final class OwnerTableCellRenderer implements TableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value,
            ...
            if ("".equals(value)) {
                ...
                Border border;
                if (hasFocus) {
                    border = getFocusBorder(table, value, isSelected, row, column);
                } else {
                    border = EMPTY_BORDER;
                }
        ...
        private Border getFocusBorder(JTable table, Object value, boolean isSelected, int row,
            ...
            if (focusBorder == null) {
                ...
                JComponent defaultRendererComponent = (JComponent) table.getDefaultRenderer(
                        String.class).getTableCellRendererComponent(table, value, isSelected, true,
                        row, column);
    ...
    private static final class OwnerTableCellEditor extends AbstractCellEditor implements
        ...
        public OwnerTableCellEditor(ContractorTableColumnModel contractorTableColumnModel,
            ...
            final JButton bookButton = contractorTableColumnModel.createBookButton();
            bookButton.setToolTipText(this.bookButtonTooltip);
            bookButton.addActionListener(this);

            bookButtonPanel = contractorTableColumnModel.createBookButtonPanel(bookButton);
        ...
        public void actionPerformed(ActionEvent e) {
            contractorTableColumnModel.presenter.bookActionPerformed(currentRow, resultsTable);
            fireEditingStopped();
        }
        ...
        public Component getTableCellEditorComponent(JTable table, Object value,
            ...
            /*
             * Store the table and the current row so they are available to the actionPerformed
             * method if the user clicks the button.
             */
            resultsTable = table;
            currentRow = row;

            bookButtonPanel.setBackground(table.getSelectionBackground());
            bookButtonPanel.setBorder(UIManager.getBorder("Table.focusCellHighlightBorder"));
            return bookButtonPanel;
        }

        public Object getCellEditorValue() {
            /*
             * Although the "owner" column is editable, the cell value is not updated through the
             * editor, so always return null here.
             */
            return null;
        }
    }
