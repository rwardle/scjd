...
public final class DatabaseFactoryImpl implements DatabaseFactory {
    ...
    private static final Logger LOGGER = Logger.getLogger(DatabaseFactoryImpl.class.getName());
     ...
     * {@inheritDoc}
     */
    public Database createDatabase(String databaseFilePath) throws FileNotFoundException,
