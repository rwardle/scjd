...
public final class ConfigurationManager {
    ...
    public ConfigurationManager(Configuration configuration) {
        ...
        if (this.configuration.exists()) {
            try {
                ...
                LOGGER.log(Level.WARNING, "Error loading configuration, using default values", e);
            }
        }
    ...
    private void verifyConfiguration() {
        /*
         * Verify that the configuration is complete and valid, use default values if not.
         */
    ...
    public String getDatabaseFilePath() {
        return configuration.getProperty(ApplicationConstants.DATABASE_FILE_PATH_PROPERTY);
    }
    ...
    public void setDatabaseFilePath(String databaseFilePath) {
        ...
        configuration.setProperty(ApplicationConstants.DATABASE_FILE_PATH_PROPERTY,
                databaseFilePath);
    }
    ...
    public String getServerAddress() {
        return configuration.getProperty(ApplicationConstants.SERVER_ADDRESS_PROPERTY);
    }
    ...
    public void setServerAddress(String serverAddress) {
        ...
        configuration.setProperty(ApplicationConstants.SERVER_ADDRESS_PROPERTY, serverAddress);
    }
    ...
    public Integer getServerPort() {
        return Integer
                .valueOf(configuration.getProperty(ApplicationConstants.SERVER_PORT_PROPERTY));
    }
    ...
    public void setServerPort(Integer serverPort) {
        ...
        configuration.setProperty(ApplicationConstants.SERVER_PORT_PROPERTY, serverPort.toString());
    }
}
