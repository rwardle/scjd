...
/**
 * An interface grouping all methods for performing Remote Method Invocation (RMI) operations.
 *
...
public interface RmiService {
     ...
     * @throws IllegalArgumentException If <code>name</code> or <code>obj</code> is <code>null</code>.
     * @see Naming#rebind(String, Remote)
     */
    void rebind(String name, Remote obj) throws RemoteException, MalformedURLException;
     ...
     */
    Remote lookup(String name) throws NotBoundException, RemoteException, MalformedURLException;
}
