...
public class DataTest {
    ...
    public void shouldThrowExceptionWhenConstructedWithNullDatabaseFile() throws Exception {
        data = new Data(null);
    }

    @Test(expected = DataValidationException.class)
    public void shouldThrowExceptionWhenConstructedWithInvalidMagicCookie() throws Exception {
        int invalidMagicCookie = -1;
        assertThat(invalidMagicCookie, is(not(DatabaseConstants.MAGIC_COOKIE)));
        checkingMagicCookieRead(invalidMagicCookie, context.sequence("construction"));
        new Data(mockDatabaseFile);
    }

    private void checkingMagicCookieRead(final int magicCookie, final Sequence sequence)
            throws Exception {
    ...
    @Test(expected = DataValidationException.class)
    public void shouldThrowExceptionWhenConstructedWithInvalidRecordLength() throws Exception {
        ...
        assertThat(invalidRecordLength, is(not(DataTestConstants.EXPECTED_RECORD_LENGTH)));
        checkingRecordLengthRead(invalidRecordLength, sequence);
        data = new Data(mockDatabaseFile);
    }

    private void checkingRecordLengthRead(final int recordLength, final Sequence sequence)
            throws Exception {
        context.checking(new Expectations() {
            {
                one(mockDatabaseFile).readInt();
    ...
    @Test(expected = DataValidationException.class)
    public void shouldThrowExceptionWhenConstructedWithInvalidFieldCount() throws Exception {
        Sequence sequence = context.sequence("construction");
        checkingMagicCookieRead(DatabaseConstants.MAGIC_COOKIE, sequence);
        checkingRecordLengthRead(DataTestConstants.EXPECTED_RECORD_LENGTH, sequence);
        short invalidFieldCount = -1;
        assertThat(invalidFieldCount, is(not(DataTestConstants.EXPECTED_FIELD_COUNT)));
        checkingFieldCount(invalidFieldCount, sequence);
        data = new Data(mockDatabaseFile);
    }

    private void checkingFieldCount(final short fieldCount, final Sequence sequence)
            throws Exception {
        context.checking(new Expectations() {
            {
    ...
    @Test(expected = DataValidationException.class)
    public void shouldThrowExceptionWhenConstructedWithInvalidFieldDescription() throws Exception {
        Sequence sequence = context.sequence("construction");
        checkingMagicCookieRead(DatabaseConstants.MAGIC_COOKIE, sequence);
        checkingRecordLengthRead(DataTestConstants.EXPECTED_RECORD_LENGTH, sequence);
    ...
    @Test(expected = DataValidationException.class)
    public void shouldThrowExceptionWhenConstructedWithInvalidDataSectionLength() throws Exception {
        final Sequence sequence = context.sequence("construction");
        checkingMagicCookieRead(DatabaseConstants.MAGIC_COOKIE, sequence);
        checkingRecordLengthRead(DataTestConstants.EXPECTED_RECORD_LENGTH, sequence);
        checkingFieldCount(DataTestConstants.EXPECTED_FIELD_COUNT, sequence);
        checkingFieldDescriptions(DataTestConstants.EXPECTED_FIELD_DESCRIPTIONS, sequence);
    ...
    private void checkingDataSectionOffset(final Sequence sequence) throws Exception {
        context.checking(new Expectations() {
            {
    ...
    private void checkingCacheDeletedRecordNumbers(final Sequence sequence) throws Exception {
        context.checking(new Expectations() {
            {
                for (int recNo = 0; recNo < recordCount; recNo++) {
                    one(mockDatabaseFile).seek(with(equal(getOffsetForRecord(recNo))));
                    inSequence(sequence);
    ...
    private void assertSchema() {
        ...
        assertThat(schema.getRecordLength(), is(DataTestConstants.EXPECTED_RECORD_LENGTH));
        assertThat(schema.getFieldCount(), is(DataTestConstants.EXPECTED_FIELD_COUNT));
        ...
        for (int i = 0; i < fieldDescriptions.length; i++) {
            assertThat(fieldDescriptions[i].getName(),
                    is(DataTestConstants.EXPECTED_FIELD_DESCRIPTIONS[i].getName()));
    ...
    private void assertDeletedRecords() {
        for (int recNo = 0; recNo < recordCount; recNo++) {
            assertThat(data.isRecordDeleted(recNo), is(deletedRecNos.contains(recNo)));
        }
    }

    @Test(expected = RecordNotFoundException.class)
    public void shouldThrowExceptionWhenReadWithNegativeRecordNumber() throws Exception {
        standardSetup();
        data.read(-1);
    }
    ...
    public void shouldTrimRecordWhenReadWithSpacePadding() throws Exception {
        standardSetup();
        read(1, DataTestConstants.RECORD_VALUES_SPACE_PADDED, DataTestConstants.RECORD_VALUES);
    }
    ...
    private void checkingSeek(final long pos, final Sequence sequence) throws Exception {
        context.checking(new Expectations() {
            {
    ...
    public void shouldTrimRecordWhenReadWithNullPadding() throws Exception {
        standardSetup();
        read(1, DataTestConstants.RECORD_VALUES_NULL_PADDED, DataTestConstants.RECORD_VALUES);
    }

    @Test(expected = RecordNotFoundException.class)
    public void shouldThrowExceptionWhenUpdatedWithNegativeRecordNumber() throws Exception {
        standardSetup();
    ...
    @Test(expected = IllegalArgumentException.class)
    public void shouldThrowExceptionWhenUpdatedWithNullDataArray() throws Exception {
        standardSetup();
        int recNo = 0;
        data.lock(recNo);
    ...
    @Test(expected = IllegalArgumentException.class)
    public void shouldThrowExceptionWhenUpdatedWithInvalidDataArrayLength() throws Exception {
        standardSetup();
        int recNo = 0;
        data.lock(recNo);
        String[] recordValues = new String[DataTestConstants.EXPECTED_FIELD_COUNT + 1];
        System.arraycopy(DataTestConstants.RECORD_VALUES, recNo, recordValues, recNo,
                DataTestConstants.RECORD_VALUES.length);
        data.update(recNo, recordValues);
    }

    @Test
    public void shouldNotWriteCorrespondingFieldWhenUpdatedWithNullRecordValue() throws Exception {
        standardSetup();
        int recNo = 1;
        data.lock(recNo);
        final Sequence sequence = context.sequence("update");
        String[] recordValues = DataTestConstants.RECORD_VALUES_SPACE_PADDED.clone();
        recordValues[1] = null;
    ...
    @Test
    public void shouldTruncateDataWhenUpdatedWithTooLongRecordValue() throws Exception {
        standardSetup();
        int recNo = 1;
        data.lock(recNo);
        final Sequence sequence = context.sequence("update");
        String[] recordValues = DataTestConstants.RECORD_VALUES.clone();
        recordValues[1] = DataTestConstants.RECORD_VALUES_SPACE_PADDED[1] + " too long";
        checkingUpdateRecord(recNo, DataTestConstants.RECORD_VALUES_SPACE_PADDED, sequence);
        data.update(recNo, recordValues);
    }

    @Test
    public void shouldBlankFieldWhenUpdatedWithEmptyStringRecordValue() throws Exception {
        standardSetup();
        int recNo = 1;
        data.lock(recNo);
        final Sequence sequence = context.sequence("update");
        ...
        paddedRecordValues[1] = DataTestConstants.padField(paddedRecordValues[1],
    ...
    @Test(expected = RecordNotFoundException.class)
    public void shouldThrowExceptionWhenUpdatingDeletedRecord() throws Exception {
        standardSetup();
    ...
    public void shouldThrowExceptionWhenNotHoldingLockOnRecordToBeUpdated() throws Exception {
        standardSetup();
        final int recNo = 1;
        Thread lockThread = new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    fail(Thread.currentThread().getName() + ": " + e.getMessage());
                }
            }
        });
        lockThread.start();
    ...
    @Test(expected = RecordNotFoundException.class)
    public void shouldThrowExceptionWhenDeleteCalledWithNegativeRecordNumber() throws Exception {
        standardSetup();
        data.delete(-1);
    }
    ...
    @Test(expected = RecordNotFoundException.class)
    public void shouldThrowExceptionWhenDeletingDeletedRecord() throws Exception {
        standardSetup();
        Integer recNo = deletedRecNos.first();
        data.delete(recNo);
    }
    ...
    private void checkingDeleteRecord(int recNo, final Sequence sequence) throws Exception {
        checkingSeek(getOffsetForRecord(recNo), sequence);
        context.checking(new Expectations() {
            {
                one(mockDatabaseFile).writeByte(DatabaseConstants.DELETED_RECORD_FLAG);
                inSequence(sequence);
            }
        });
    }
    ...
    @Test(expected = IllegalStateException.class)
    public void shouldThrowExceptionWhenNotHoldingLockOnRecordToBeDeleted() throws Exception {
        standardSetup();
        final int recNo = 1;
        Thread lockThread = new Thread(new Runnable() {
            public void run() {
    ...
    private Thread createThreadThatLocksRecordAndExpectsException(final int recNo) {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void shouldThrowExceptionWhenCreateCalledWithNullDataArray() throws Exception {
        standardSetup();
        data.create(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void shouldThrowExceptionWhenCreateCalledWithInvalidDataArrayLength() throws Exception {
        standardSetup();
        String[] recordValues = new String[DataTestConstants.EXPECTED_FIELD_COUNT + 1];
    ...
    @Test(expected = IllegalArgumentException.class)
    public void shouldThrowExceptionWhenCreateCalledWithNullRecordValue() throws Exception {
        standardSetup();
        String[] recordValues = DataTestConstants.RECORD_VALUES_SPACE_PADDED.clone();
        recordValues[1] = null;
        data.create(recordValues);
    ...
    @Test
    public void shouldWriteToEndOfFileWhenCreateCalledAndNoDeletedRecordsExist() throws Exception {
        deletedRecNos.clear();
        standardSetup();
        int recNoToWrite = recordCount;
        Sequence sequence = context.sequence("create");
        checkingCreateRecord(recNoToWrite, DataTestConstants.RECORD_VALUES_SPACE_PADDED, sequence);
        assertThat(data.create(DataTestConstants.RECORD_VALUES), is(recNoToWrite));
    ...
    @Test(expected = IllegalArgumentException.class)
    public void shouldThrowExceptionWhenFindCalledWithNullCriteriaArray() throws Exception {
        standardSetup();
        data.find(null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void shouldThrowExceptionWhenFindCalledWithInvalidCriteriaArrayLength() throws Exception {
        standardSetup();
    ...
    private void checkingFindRecords(final String[][] allRecordValues, final Sequence sequence)
            throws Exception {
        for (int recNo = 0; recNo < recordCount; recNo++) {
    ...
    @Test(expected = RecordNotFoundException.class)
    public void shouldThrowExceptionWhenIsLockedCalledWithNegativeRecordNumber() throws Exception {
        standardSetup();
        data.isLocked(-1);
    }
    ...
    @Test(expected = RecordNotFoundException.class)
    public void shouldThrowExceptionWhenIsLockedCalledOnDeletedRecord() throws Exception {
        standardSetup();
        data.isLocked(deletedRecNos.first());
    }

    @Test
    public void shouldReturnTrueWhenIsLockedCalledOnLockedRecord() throws Exception {
        standardSetup();
        int recNo = 1;
        data.lock(recNo);
        assertThat(data.isLocked(recNo), is(true));
    ...
    @Test
    public void shouldReturnFalseWhenIsLockedCalledOnUnlockedRecord() throws Exception {
        standardSetup();
        int recNo = 1;
    ...
    @Test(expected = RecordNotFoundException.class)
    public void shouldThrowExceptionWhenLockCalledWithNegativeRecordNumber() throws Exception {
        standardSetup();
        data.lock(-1);
    }
    ...
    @Test(expected = RecordNotFoundException.class)
    public void shouldThrowExceptionWhenLockCalledForDeletedRecord() throws Exception {
        standardSetup();
    ...
    @Test
    public void shouldBeAbleToLockDifferentRecordsConcurrently() throws Exception {
        standardSetup();
        int firstRecNo = 1;
        ...
        Thread lockingThread = new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    assertTrue("Exception cause was not an InterruptedException",
    ...
    @Test(expected = RecordNotFoundException.class)
    public void shouldThrowExceptionWhenUnlockCalledWithNegativeRecordNumber() throws Exception {
        standardSetup();
        data.unlock(-1);
    }
    ...
    @Test(expected = RecordNotFoundException.class)
    public void shouldThrowExceptionWhenUnlockCalledOnDeletedRecord() throws Exception {
        standardSetup();
    ...
    @Test(expected = IllegalStateException.class)
    public void shouldThrowExceptionFromCallToUnlockIfRecordNotLocked() throws Exception {
        standardSetup();
        int recNo = 0;
        assertThat(data.isLocked(recNo), is(false));
        data.unlock(recNo);
    ...
    @Test(expected = IllegalStateException.class)
    public void shouldThrowExceptionFromCalledToUnlockIfThreadDoesNotHoldLock() throws Exception {
        standardSetup();
        final int recNo = 1;
        Thread lockThread = new Thread(new Runnable() {
            public void run() {
